#!/usr/bin/env python3
"""
Street Sunset Finder - Streamlit Web Application

This Streamlit app displays a map and calendar interface for exploring
streets where the sun sets directly at the end on specific dates.
"""
...
# Page configuration
st.set_page_config(
    page_title="Street Sunset Finder",
    page_icon="🌅",
    layout="wide",
...
def create_map(gdf, selected_date=None, center_lat=37.7749, center_lon=-122.4194, window_height=None):
    """
    ...
    # Update layout
    fig.update_layout(
        title=f"Street Map - {selected_date.strftime('%B %d, %Y') if selected_date else 'All Streets'}",
        xaxis=dict(
            range=[x_min, x_max],
            showgrid=False,
...
def main():
    ...
    # Header
    # st.markdown('<h1 class="main-header">🌅 Street Sunset Finder</h1>', unsafe_allow_html=True)
    ...
    with st.sidebar:
        ...
        csv_file = st.file_uploader(
            "Upload Street Data (CSV)",
            type=['csv'],
            help="Upload a CSV file containing street data with geometry or coordinates"
        )
    ...
    if csv_file is not None:
        # Load street data
        with st.spinner("Loading street data..."):
        ...
        if gdf is not None:
            ...
            with col1:
                ...
                map_obj = create_map(gdf, selected_date, 37.7749, -122.4194, map_height)
        ...
        with st.expander("📋 Expected Data Format"):
            ...
            **Option 1: Geometry column**
            ...
            "Main St","LINESTRING(-122.4194 37.7749, -122.4184 37.7759)","['2024-06-21T18:30:00', '2024-06-22T18:31:00']",300.5
            ```
            
            **Option 2: Start/End coordinates**
            ```csv
            Route_Name,start_lon,start_lat,end_lon,end_lat,henge_time,azimuth
            "Main St",-122.4194,37.7749,-122.4184,37.7759,"['2024-06-21T18:30:00', '2024-06-22T18:31:00']",300.5
            ```
